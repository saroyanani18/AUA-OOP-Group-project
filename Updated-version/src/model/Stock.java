...
public class Stock {
    ...
    private static final DecimalFormat idk = new DecimalFormat("#.##");
    /**
     * Constructor.
     * 
    ...
    currentPrice = currentPrice + currentPrice * (float)(Math.random()* 0.2 - 0.1);
   //  currentPrice = currentPrice * ((Math.random() * (2 - 0.1) + 0.1));
    currentPrice = currentPrice * 100;
    currentPrice = (double)((int) currentPrice);
    currentPrice = currentPrice/100;
    }
