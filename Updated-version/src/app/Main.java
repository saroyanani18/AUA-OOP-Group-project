...
//    Existing stocks
    public static List<Stock> stocks = Arrays.asList(new Stock("AAPL", "Apple Inc, designs, manufactures and markets mobile communication and media devices, personal computers and portable digital music players worldwide.", 122.02, 100000000), 
                                                     new Stock("MSFT", "Microsoft Corp, develops, licenses, markets and supports software, services and devices worldwide.", 42.60, 200000000),
