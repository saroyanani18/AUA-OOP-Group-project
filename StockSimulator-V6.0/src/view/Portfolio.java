...
public class Portfolio extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        title.setBackground(new java.awt.Color(36, 45, 63));
        ...
        lbTitle.setForeground(new java.awt.Color(67, 79, 101));
        ...
        tbPortfolioShorting.setSelectionBackground(new java.awt.Color(145, 161, 187));
        tbPortfolioShorting.setSelectionForeground(new java.awt.Color(35, 44, 63));
        ...
        tbPortfolio.setSelectionBackground(new java.awt.Color(145, 161, 187));
        tbPortfolio.setSelectionForeground(new java.awt.Color(35, 44, 63));
        ...
        jLabel1.setForeground(new java.awt.Color(73, 76, 83));
        ...
        jLabel2.setForeground(new java.awt.Color(73, 76, 83));
        jLabel2.setText("Shorting stocks");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        pFooter.setBackground(new java.awt.Color(36, 45, 63));
