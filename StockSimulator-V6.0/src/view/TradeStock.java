...
public class TradeStock extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        title.setBackground(new java.awt.Color(35, 44, 64));
        ...
        lbTitle.setForeground(new java.awt.Color(35, 44, 64));
        ...
        pBorder.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Trade Settings", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Roboto", 2, 14), new java.awt.Color(67, 80, 100))); // NOI18N
        pBorder.setForeground(new java.awt.Color(67, 80, 100));
        ...
        btnBack.setBackground(new java.awt.Color(66, 78, 100));
        btnBack.setFont(new java.awt.Font("Roboto", 1, 18)); // NOI18N
        btnBack.setForeground(new java.awt.Color(255, 255, 255));
        btnBack.setText("Cancel operation");
        btnBack.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(67, 79, 100), 1, true));
        ...
        btnPerform.setBackground(new java.awt.Color(66, 78, 100));
        btnPerform.setFont(new java.awt.Font("Roboto", 1, 18)); // NOI18N
        btnPerform.setForeground(new java.awt.Color(255, 255, 255));
        btnPerform.setText("Perform operation");
        btnPerform.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(67, 79, 100), 1, true));
        btnPerform.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        btnPerform.setMargin(new java.awt.Insets(0, 0, 0, 0));
