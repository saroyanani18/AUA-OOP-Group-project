...
public class EnterAccount extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        mainPanel.setBackground(new java.awt.Color(217, 219, 226));
        mainPanel.setLayout(new java.awt.BorderLayout());

        header.setBackground(new java.awt.Color(35, 44, 64));
        ...
        optionPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Select an option", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Roboto", 1, 14), new java.awt.Color(67, 80, 100))); // NOI18N
        ...
        lbHaveAccount.setForeground(new java.awt.Color(67, 80, 100));
        lbHaveAccount.setText("Do you have an account?");
        optionPanel.add(lbHaveAccount);

        rbYes.setBackground(new java.awt.Color(217, 219, 226));
        rbYes.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        rbYes.setForeground(new java.awt.Color(67, 80, 100));
        rbYes.setSelected(true);
        rbYes.setText("Yes");
        optionPanel.add(rbYes);

        rbNo.setBackground(new java.awt.Color(217, 219, 226));
        rbNo.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        rbNo.setForeground(new java.awt.Color(67, 80, 100));
        rbNo.setText("No");
        ...
        jSeparator1.setBackground(new java.awt.Color(35, 44, 64));
        jSeparator1.setForeground(new java.awt.Color(35, 44, 64));
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        lbAccountName.setForeground(new java.awt.Color(67, 80, 100));
        ...
        jSeparator2.setBackground(new java.awt.Color(35, 44, 64));
        jSeparator2.setForeground(new java.awt.Color(35, 44, 64));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        btnLogin.setBackground(new java.awt.Color(35, 44, 64));
        ...
        btnExit.setBackground(new java.awt.Color(35, 44, 64));
